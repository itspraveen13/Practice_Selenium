...
//	public class dataProvider2 extends dataUtils {  - using inheritance
	
	@Test(dataProvider = "Creds", dataProviderClass = dataUtils.class) //using dataProviderClass -> dataUtils.class
